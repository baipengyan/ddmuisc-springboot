...
public class FileStore{
    ...
    public FileStore(ServletContext servletContext) {
    ...
    private void initResourceRootFile(){
        //resourceRootFile= new File(ResourceUtils.getFile("classpath:"), resourceRootPath);
        resourceRootFile= new File(resourceRootPath);
    }
