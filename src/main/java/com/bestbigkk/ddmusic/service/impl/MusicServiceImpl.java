...
import com.bestbigkk.ddmusic.service.MusicService;
...
import com.bestbigkk.ddmusic.vo.MusicListPage;
...
public class MusicServiceImpl implements MusicService {
    ...
    public JSONObject updateMusic(Music music, HttpServletRequest request, HttpServletResponse response) {
        ...
        //信息修改完成，删除旧资源
        if (move!=null && aimMusic.getCover() != null && !aimMusic.getCover().equals(fileStore.getDefaultImagePath())) {
    ...
    public JSONObject uploadMusic(HttpServletRequest request, HttpServletResponse response, Music music) {
        ...
        if(cover!=null){
            ...
            music.setCover(fileStore.getDefaultImagePath());
        }
        if(lyric!=null){
        ...
        music.setCover(coverFileMoved==null ? fileStore.getDefaultImagePath() :coverFileMoved);
        ...
        class Deleter implements Runnable{
            ...
            public void run() {
                while (!musics.isEmpty()) {
                    ...
                    if(music.getCover()!=null && !music.getCover().equals(fileStore.getDefaultImagePath())){
