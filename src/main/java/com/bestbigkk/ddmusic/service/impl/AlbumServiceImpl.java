package com.bestbigkk.ddmusic.service.impl;

import com.alibaba.fastjson.JSONObject;
import com.bestbigkk.ddmusic.dao.AlbumMapper;
import com.bestbigkk.ddmusic.dao.MusicMapper;
import com.bestbigkk.ddmusic.entity.Album;
import com.bestbigkk.ddmusic.entity.Music;
import com.bestbigkk.ddmusic.po.AlbumExample;
import com.bestbigkk.ddmusic.po.MusicExample;
import com.bestbigkk.ddmusic.service.AlbumService;
import com.bestbigkk.ddmusic.service.common.FileStore;
import com.bestbigkk.ddmusic.service.common.FileStoreService;
import com.bestbigkk.ddmusic.service.common.RequestIdentity;
...
import static com.bestbigkk.ddmusic.config.KeyStore.*;
...
public class AlbumServiceImpl implements AlbumService{
    ...
    public JSONObject createAlbumList(Album album, HttpServletRequest request, HttpServletResponse response) {
        ...
        if(album.getCover()==null || "".equals(album.getCover())){
            album.setCover(fileStore.getDefaultImagePath());
        }else{
    ...
    public JSONObject updateAlbum(Album album, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (album == null || album.getId()==null || album.getName()!=null && album.getName().length()>16 ||
                album.getIntroduce()!=null && album.getIntroduce().length()>100) {
        ...
        album.setCover(null);
        if (newCover != null && !"".equals(newCover) && !newCover.equals(aimAlbum.getCover())) {
            ...
            //旧封面如果是默认图片，不删除
            boolean deleteOldCover = oldCover!=null && oldCover.equals(fileStore.getDefaultImagePath());
            if (!deleteOldCover) {
    ...
    public JSONObject deleteAlbum(Integer id, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (cover != null && !cover.equals(fileStore.getDefaultImagePath())) {
