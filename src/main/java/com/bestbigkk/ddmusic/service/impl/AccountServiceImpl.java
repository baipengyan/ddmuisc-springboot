...
import com.bestbigkk.ddmusic.dao.UserMapper;
...
import com.bestbigkk.ddmusic.service.common.SmsService;
import com.bestbigkk.ddmusic.service.common.VerifyImage;
import com.bestbigkk.ddmusic.utils.SpringContextUtil;
import com.bestbigkk.ddmusic.vo.AccountPage;
...
public class AccountServiceImpl implements AccountService {
    ...
    public JSONObject getPhoneVerifyCode(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(lastRequestTime!=null && lastRequestTime.getTime()+SMS_TIME_THRESHOLD>System.currentTimeMillis()){
            jsonObject.put("msg", "请求过于频繁，请"+(SMS_TIME_THRESHOLD/1000-(System.currentTimeMillis()-lastRequestTime.getTime())/1000)+"秒之后再试");
            return jsonObject;
        }
